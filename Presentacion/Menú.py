...
class Menu:
    ...
    def opcion_crear_reserva(self):
        ...
        mensaje = self.bd.crear_reserva({'Nombre_Reserva': nombre_reserva, 'Cantidad_Comensales': cantidad_comensales})
        print(mensaje)
    ...
    def opcion_actualizar_reserva(self):
        ...
        mensaje = self.bd.actualizar_reserva(nombre_reserva, nueva_reserva, cantidad_comensales)
        print(mensaje)
